...
#include <jni.h>
#include <common.h>
#include "com_gherynos_libsaltpack_Utils.h"

void Java_com_gherynos_libsaltpack_Utils_generateKeypair(JNIEnv *env, jclass cls, jbyteArray publickeyA,
...
void Java_com_gherynos_libsaltpack_Utils_generateSignKeypair(JNIEnv *env, jclass cls, jbyteArray publickeyA,
                                                            jbyteArray secretkeyA) {
...
jbyteArray Java_com_gherynos_libsaltpack_Utils_derivePublickey(JNIEnv *env, jclass cls, jbyteArray secretkeyA) {
...
jint Java_com_gherynos_libsaltpack_Utils_baseXblockSize(JNIEnv *env, jclass cls, jstring alphabetS, jint size) {
...
jstring
Java_com_gherynos_libsaltpack_Utils_baseXencode___3BLjava_lang_String_2(JNIEnv *env, jclass cls, jbyteArray dataA,
                                                                       jstring alphabetS) {
...
jstring
Java_com_gherynos_libsaltpack_Utils_baseXencode___3BILjava_lang_String_2(JNIEnv *env, jclass cls, jbyteArray dataA,
...
jbyteArray Java_com_gherynos_libsaltpack_Utils_baseXdecode(JNIEnv *env, jclass cls, jstring dataS, jstring alphabetS) {
...
jbyteArray Java_com_gherynos_libsaltpack_Utils_hexToBin(JNIEnv *env, jclass cls, jstring dataS) {
...
jstring Java_com_gherynos_libsaltpack_Utils_binToHex(JNIEnv *env, jclass cls, jbyteArray dataA) {
...
jbyteArray Java_com_gherynos_libsaltpack_Utils_generateRandomBytes(JNIEnv *env, jclass cls, jlong size) {
...
jbyteArray
Java_com_gherynos_libsaltpack_Utils_deriveKeyFromPassword(JNIEnv *env, jclass cls, jlong keySize, jcharArray passwordA,
